...
if __name__ == "__main__":
    ...
    # start_training("diagonal", "small", resolution)
    # start_training("diagonal", "medium", resolution)
    # start_training("diagonal", "large", resolution)
    # start_training("checkerboard", "medium", resolution)
    start_training("checkerboard", "large", resolution)
